...
export default function LiteModeToggle() {
    ...
    return (
        <button
            ...
            className={`hidden md:flex fixed bottom-4 left-4 z-50 items-center gap-2 px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 backdrop-blur-sm border ${isLiteMode
