    ...
    return (
        <div className="relative z-10 font-sans text-stone-800">
            ...
            <section className="py-32 px-6 max-w-3xl mx-auto text-center">
                <FadeIn>
                    <p className="text-4xl text-stone-900 font-serif leading-snug mb-12">
                ...
                <div className="space-y-6 text-xl text-stone-500 font-light">
                    ...
                    <FadeIn delay={0.8}>
                        <p className="text-stone-900 font-medium text-2xl mt-8">Just presence — practiced gently.</p>
                    </FadeIn>
                </div>
            </section>
            ...
            <section className="py-32 px-6 text-center">
                <FadeIn>
                    ...
                    <h1 className="text-6xl md:text-8xl font-serif text-amber-900 mb-6">The Inner Atlas</h1>
            ...
            <section className="py-24 px-6 max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-serif text-stone-800">One small noticing per day.</h2>
                </div>
            ...
            <section className="py-32 px-6 max-w-3xl mx-auto text-center border-t border-stone-200/50 mt-12">
                <FadeIn>
                    <p className="text-3xl text-stone-800 font-light leading-relaxed mb-6">
            ...
            <section className="py-32 px-6 text-center bg-gradient-to-b from-transparent to-stone-100/50">
                <FadeIn>
                    <h2 className="text-4xl md:text-6xl font-serif text-stone-900 mb-8">Walk with us for 30 days.</h2>
                    ...
                    <div className="flex flex-col items-center gap-6">
                        <Link
                            href="/inner-atlas"
                            className="px-10 py-4 bg-stone-900 text-stone-50 rounded-full text-lg font-medium hover:bg-amber-900 transition-colors shadow-xl hover:shadow-2xl hover:shadow-amber-900/20"
                        >
                            Start the journey
                        </Link>
...
function RitualCard({ title, desc }: { title: string, desc: string }) {
    return (
        <motion.div
            ...
            whileHover={{ y: -5 }}
        >
            <h3 className="text-amber-900/60 font-medium uppercase tracking-widest text-sm mb-4">{title}</h3>
