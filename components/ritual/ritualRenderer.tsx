...
/**
 * Maps ritual visual keys to their respective React components
 */
export function getRitualVisual(visualKey: string, opacity: number, prefersReducedMotion: boolean): React.ReactElement {
    ...
    return visualComponents[visualKey] || <SkyHorizon opacity={opacity} prefersReducedMotion={prefersReducedMotion} />;
}
...
function SkyHorizon({ opacity, prefersReducedMotion }: VisualProps) {
    return (
        <motion.div
...
function FullMoonSky({ opacity, prefersReducedMotion }: VisualProps) {
    return (
        <>
...
function GroundForwardDrift({ opacity, prefersReducedMotion }: VisualProps) {
    return (
        <motion.div
...
function SoundWaves({ opacity, prefersReducedMotion }: VisualProps) {
    return (
...
function BreathGlow({ opacity, prefersReducedMotion }: VisualProps) {
    return (
        <motion.div
...
function WarmParticles({ opacity, prefersReducedMotion }: VisualProps) {
    return (
...
function FlameFlicker({ opacity, prefersReducedMotion }: VisualProps) {
    return (
        <motion.div
