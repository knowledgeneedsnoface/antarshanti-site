...
export default function RitualAssignment({
    ...
    return (
        <div className="relative w-full h-full bg-gradient-to-br from-[#fdfbf7] to-[#f4ecd8] text-[#1a1a2e] font-sans overflow-y-auto overflow-x-hidden">
            ...
            <div className="min-h-full w-full flex items-center justify-center p-6 py-12 relative z-10">
                <motion.div
